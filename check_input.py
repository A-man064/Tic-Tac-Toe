...
'''Made by Me, Modifies get int range to also accept on letter'''
def get_int_range_letter(prompt, low, high, letter):
    while True:
        ...
        try:
            ...
            print(f"Invalid input - should be an integer or the letter '{letter}'.")
...
'''Written by Adam. Checks the Users answer and returns none is answer is invalid'''
def check_answer(answer, low, high):
  val = 0
  valid = False
  while not valid:
    try:
      ...
      if val >= low and val <= high:
        ...
        print("Invalid answer, you don't do anyting")
        return None
    except ValueError:
      print("Invalid answer, you don't do anything")
      return None
